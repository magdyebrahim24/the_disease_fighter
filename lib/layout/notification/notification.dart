...
class _NotificationsState extends State<Notifications> {
  ShowPatientNotificationController _patientNotificationController=ShowPatientNotificationController();
            ...
            builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
              if (snapshot.connectionState==ConnectionState.waiting) {
                ...
                if (snapshot.hasError) {
                  ...
                  return snapshot.data.notifications != null  && snapshot.data.notifications.length != 0
                      ?    ListView.builder(
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            onTap: () => Navigator.push(context,
                                MaterialPageRoute(builder: (context) => RateScreen(sessionId: snapshot.data.notifications[index].sessionId,data: snapshot.data.notifications[index],))),
                            child: Container(
                                  ...
                                  Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image:
                                          AssetImage('assets/doctors_img/doc3.jpg'),
                                          fit: BoxFit.cover,
                                        ),
                                      )),
                                  Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text.rich(
                                            TextSpan(
                                              text: snapshot.data.notifications[index].doctorName.toString(),
                                              style: new TextStyle(
                                          ...
                                          Text(
                                            snapshot.data.notifications[index].time.toString(),
                                            style: TextStyle(
                                              color: subTextColor,
                                              fontSize: 12,
                                              // fontWeight: FontWeight.bold,
