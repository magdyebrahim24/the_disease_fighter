                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TxtField(
                          ...
                          hintText: Languages.of(context)!.signIn['emailHint'],
                        ...
                        TxtField(
                          labelText: Languages.of(context)!.signIn['password'],
                          hintText:
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(bottom: 35, right: 5, left: 5),
                          child: Row(
                        ...
                        RoundedButton(
                          fun: () => _userLogin(),
                          text: Languages.of(context)!.signIn['signButtonTxt'],
                        ),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                  ...
                                  child: Text(
                                    Languages.of(context)!.signIn['signUpTxt'],
                                    style: TextStyle(
