...
class ImgCrop extends StatefulWidget {
  ...
  ImgCrop(
      ...
      : assert(image != null),
        ...
        assert(handleSize != null && handleSize >= 0.0) ,       super(key: key);
  ...
  ImgCrop.file(File file,
      ...
      : image = FileImage(file, scale: scale),
        assert(maximumScale != null),       super(key: key);
...
class ImgCropState extends State<ImgCrop> with TickerProviderStateMixin, Drag {
  ...
  Size get _boundaries {
    // Size temp = _surfaceKey.currentContext!.size! - Offset(widget.handleSize!, widget.handleSize!) ;
    Size temp = _surfaceKey.currentContext!.size!  * 1 ;
    return temp;
  }
