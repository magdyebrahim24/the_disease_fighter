...
class GetSessionsController {
  ...
  factory GetSessionsController.fromJson(String str) =>
      GetSessionsController.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetSessionsController.fromMap(Map<String, dynamic> json) =>
      GetSessionsController(
        futureAppointments: List<Appointment>.from(
            json["future_appointments"].map((x) => Appointment.fromMap(x))),
        previousAppointments: List<Appointment>.from(
            json["previous_appointments"].map((x) => Appointment.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        "future_appointments":
            List<dynamic>.from(futureAppointments!.map((x) => x.toMap())),
        "previous_appointments":
            List<dynamic>.from(previousAppointments!.map((x) => x.toMap())),
        "success": success,
