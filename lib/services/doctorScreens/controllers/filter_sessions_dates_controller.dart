...
class FilterSessionByDateController {
  ...
  FilterDoctorSessionsModel _filterDoctorSessionsModel =
      FilterDoctorSessionsModel();
  ...
  Future<FilterDoctorSessionsModel> getFilteredSessions({sessionDate}) async {
    ...
    _filterDoctorSessionsModel =
        FilterDoctorSessionsModel.fromJson(jsonResponse);
