...
class OneSpecializationModel {
  List<Doctors>? doctors;
  int? specialization;
  bool? success;
  int? totalDoctorsInSpecialization;

  OneSpecializationModel(
      {this.doctors,
        this.specialization,
        this.success,
        this.totalDoctorsInSpecialization});

  OneSpecializationModel.fromJson(Map<String, dynamic> json) {
    ...
    totalDoctorsInSpecialization = json['total_doctors_in_specialization'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_doctors_in_specialization'] = this.totalDoctorsInSpecialization;
    return data;
  }
}
